...
public class SynthGenerator extends AbstractGenerator {
	...
	final private double prob_plan_has_single_goal;
				   ...
				   int num_sel, int num_lit, double prob)
	{
		...
		this.prob = prob;
		this.prob_plan_has_single_goal = 0.0; // Disable by setting to 0.0
	}
...
//            }
	...
	private GoalNode createGoal(int depth, ArrayList<Literal> as, ArrayList<Literal> ps, ArrayList<Literal> gcs){
		...
		int num_plans = num_plan;
		if (rm.nextDouble() < this.prob_plan_has_single_goal)
		{
			num_plans = 1;
		}
